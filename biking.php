...
// Vérifiez si l'utilisateur est connecté
  ...
  <main>
    <div class="gauche-encadrement">
      <h2>Biking</h2>
      <p>Le monde du vélo t'attend avec impatience ! Que tu sois débutant ou que tu souhaites simplement perfectionner ta technique, nos cours de vélo t'offrent bien plus qu'une simple leçon. Découvre le bonheur sur deux roues, explore des horizons inédits, et connecte-toi avec une communauté passionnée. Ne laisse pas cette opportunité passer.</p>
    </div>

    <a href="coachbiking2.php" class="droit-encadrement">
      <h2>Chris Bratt</h2>
    </a>

    <img src="velo.jpg" class="background-image">
  </main>
</body>
</html>